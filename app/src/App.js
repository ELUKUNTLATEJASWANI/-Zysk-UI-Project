...
function App() {
  return (
    <div className="App">
      ...
      <section className="feature-section">
        ...
        <div className="button-group">
          <button className="demo-btn">
            <img src={require('./assets/images/Icon.png')} alt="play" className="icon" /> Demo
          </button>
      ...
      <section className="image-section">
        <img src={require('./assets/images/3X2 screen.png')} alt="banner" className="banner-image" />
      </section>
  ...
  <div className="logos-container">
            <img src={require('./assets/images/boltshift-logo.png')} alt="Boltshift" className="company-logo" />
            <img src={require('./assets/images/lightbox-logo.png')} alt="LightBox" className="company-logo" />
            <img src={require('./assets/images/featerdev-logo.png')} alt="Featerdev" className="company-logo" />
            <img src={require('./assets/images/spherule-logo.png')} alt="Spherule" className="company-logo" />
            <img src={require('./assets/images/globalbank-logo.png')} alt="GlobalBank" className="company-logo" />
            <img src={require('./assets/images/nietzsche-logo.png')} alt="Nietzsche" className="company-logo" />
          </div>
        </div>
      </section>
      ...
      <section className="features-section">
        ...
        <div className="features-grid">
          ...
          <div className="feature-item">
            <img src={require('./assets/images/Featured icon (3).png')} alt="Feature 4" className="feature-icon" />
          ...
          <div className="feature-item">
            <img src={require('./assets/images/Featured icon (4).png')} alt="Feature 5" className="feature-icon" />
          ...
          <div className="feature-item">
            <img src={require('./assets/images/Featured icon (5).png')} alt="Feature 6" className="feature-icon" />
